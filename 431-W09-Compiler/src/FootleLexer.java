// $ANTLR 2.7.7 (20060906): "431-W09-Compiler/src/footle.g" -> "FootleLexer.java"$
...
public class FootleLexer extends antlr.CharScanner implements FootleLexerTokenTypes, TokenStream
 {
public FootleLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public FootleLexer(Reader in) {
	this(new CharBuffer(in));
}
public FootleLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public FootleLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("if", this), new Integer(6));
	literals.put(new ANTLRHashString("function", this), new Integer(9));
	...
	literals.put(new ANTLRHashString("return", this), new Integer(5));
	literals.put(new ANTLRHashString("new", this), new Integer(12));
}
...
/******/
	...
	public final void mFLOAT_OR_INT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = FLOAT_OR_INT;
		int _saveIndex;
