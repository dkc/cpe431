...
public FootleTreeParser() {
	...
	public final void ifnoelse(AST _t) throws RecognitionException {
		
		AST ifnoelse_AST_in = (_t == ASTNULL) ? null : (AST)_t;
	...
	public final void ifelse(AST _t) throws RecognitionException {
		
		AST ifelse_AST_in = (_t == ASTNULL) ? null : (AST)_t;
	...
	public final void const(AST _t) throws RecognitionException {
		
		AST const_AST_in = (_t == ASTNULL) ? null : (AST)_t;
		AST i = null;
